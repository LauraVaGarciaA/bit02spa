...
export const PaginaAcerca = () => {
    return (
        ...
        <div className="contenedor4">
            <p>
                <h2>¡Ven por una flor!🌻</h2>Es un lugar lleno de belleza y fragancia, donde se pueden encontrar una gran variedad de flores y arreglos florales para celebrar ocasiones especiales, 
                expresar emociones y embellecer espacios. 
                Es un espacio dedicado al arte floral y al amor por la naturaleza.</p> 
        </div>
        </div>
        </>
    )
